        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-950 dark:text-white font-heading tracking-tight leading-tight">
              Master MTG Draft & Sealed with Data-Driven Instincts
            </h1>
              ...
              {activeTab === 'oauth' && (
                <div className="space-y-3">
                  <button
                    ...
                    disabled={isLoading}
                    className="w-full py-2.5 px-4 rounded-xl bg-white dark:bg-[#0c1236] hover:bg-slate-50 dark:hover:bg-[#121a4a] border border-slate-300 dark:border-slate-700 text-xs font-bold text-slate-800 dark:text-white flex items-center justify-center gap-3 transition-all shadow-xs cursor-pointer disabled:opacity-60"
                  >
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className="w-full py-2.5 px-4 rounded-xl bg-slate-900 hover:bg-black text-white text-xs font-bold flex items-center justify-center gap-3 transition-all shadow-xs cursor-pointer disabled:opacity-60"
                  >
                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
